        ...
        $("#resource-properties-dialog").dialog({
            ...
            buttons: {
                ...
                "Apply": function() {
                    ...
                    $.getJSON("v1/resources/collections", params,
                        function(data) {
                            $(dialog).dialog("close");
                            $this.reload();
                        }
...
// 		this.grid.render();
	...
	Constr.prototype.load = function (start, end) {
	   if (this.loading) {
		...
		var params = { "rs:root": this.collection, "rs:view": "r", "rs:start": start, end: end };
    ...
    Constr.prototype.properties = function() {
        ...
        if (resources.length > 0) {
            $("#resource-properties-content").load("v1/resources/collections", { "properties": resources });
